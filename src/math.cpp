...
[[nodiscard]] Vec3_256& operator+=(Vec3_256& a, const Vec3_256& b) {
...
[[nodiscard]] Vec3_256 operator-(const Vec3_256& a) {
  // -1
  const __m256 invert = _mm256_sub_ps(_mm256_setzero_ps(), global::white);
  return Vec3_256{
...
[[nodiscard]] Vec3_256& operator/=(Vec3_256& a, const __m256& b) {
...
[[nodiscard, gnu::hot]] __m256 dot(const Vec3_256& a, const Vec3_256& b) {
